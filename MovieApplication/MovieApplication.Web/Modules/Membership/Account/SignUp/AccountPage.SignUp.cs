...
using MovieApplication.Administration;
using MovieApplication.Administration.Entities;
using MovieApplication.Administration.Repositories;
using MovieApplication.Common;
using Serenity;
using Serenity.Data;
...
namespace MovieApplication.Membership.Pages
{
